/**
 * CardSwap Component
 * GSAP-powered 3D card stack with automated cycling and depth perception.
 */
import React, {
...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ customClass, ...rest }, ref) => (
    <div
      ref={ref}
      {...rest}
      className={`absolute top-1/2 left-1/2 rounded-2xl border border-white/10 bg-white shadow-xl
...
export const CardSwap: React.FC<CardSwapProps> = ({
  ...
  return (
    <div ref={container} className="relative [perspective:1200px] transform-gpu" style={{ width, height }}>
